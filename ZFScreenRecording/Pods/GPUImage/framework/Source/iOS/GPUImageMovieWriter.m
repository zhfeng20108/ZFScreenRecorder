...
//                                                           nil];
//    sourcePixelBufferAttributesDictionary = [NSDictionary dictionaryWithObjectsAndKeys: [NSNumber numberWithInt:kCVPixelFormatType_32ARGB], kCVPixelBufferPixelFormatTypeKey,
//                                                           [NSNumber numberWithInt:videoSize.width], kCVPixelBufferWidthKey,
//                                                           [NSNumber numberWithInt:videoSize.height], kCVPixelBufferHeightKey,
//                                                           nil];
...
//    if (_hasAudioTrack && CMTIME_IS_VALID(startTime))
    if (_hasAudioTrack)
    {
        ...
        NSLog(@"%@",audioBuffer);
        NSLog(@"\n\n音频的;;;;;;\n%zd\n%zd\n%zd\n%zd\n\n",currentSampleTime.value, currentSampleTime.timescale,currentSampleTime.flags,currentSampleTime.epoch);
